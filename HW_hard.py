...
def process_user_choice(choice, person):
    if choice == 1:
        ...
        print('Для возврата в предыдущее меню, укажите сумму "0".')
        count = float(input('Сумма к снятию:'))
        if count >= 0:
            print(withdraw_money(person, count))
        else:
            print("Вы указали неверную сумму, повторите попытку.")
...
def start():
    try:
        ...
        print("Вы допустили ошибку в веденных данных, попробуйте еще раз.")
        start()
